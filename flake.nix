              ...
              [
                ...
                ({ config, lib, pkgs, modulesPath, ... }: {
                  ...
                  image.baseName =
                    ...
                    in lib.mkOverride 40 "nixos-uc-cm${cfg.variant}";
                  ...
                  environment.systemPackages = with pkgs; [ wirelesstools iw gitMinimal ];
                  ...
                  system.nixos.tags =
                    let cfg = config.boot.loader.raspberryPi;
                    in [ "uc-cm${cfg.variant}" ];
                  system.stateVersion = "25.11";
                  system.defaultChannel = "https://nixos.org/channels/nixos-unstable";
                  systemd.services."serial-getty@ttyS0".enable = false;
                  imports = [ (lib.mkAliasOptionModule [ "environment" "checkConfigurationOptions" ] [ "_module" "check" ]) ];
